<template>
	<!-- <el-header>
		<el-menu background-color="#2563eb" text-color="#FFFFFF" active-text-color="#FFFFFF" mode="horizontal">
	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#ffffff","headFontSize":"20px","headUserInfoFontColor":"#ffffff","headBoxShadow":"0 1px 6px #93c5fd","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"#2563eb","headFontColor":"#ffffff","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#2563eb","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"#ffffff","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
