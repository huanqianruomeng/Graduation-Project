<template>
  <el-breadcrumb class="app-breadcrumb" separator="⭐⭐" style="height:50px;backgroundColor:rgba(37, 99, 235, 1);borderRadius:16px;padding:0px 20px 0px 20px;boxShadow:;borderWidth:2px;borderStyle:dotted solid double dashed;borderColor:rgba(147, 197, 253, 0.35);">
