    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shiyanshihao"
              placeholder="实验室号"
              clearable
              :readonly="ro.shiyanshihao"
            ></el-input>
          </el-form-item>
          <div v-else>
