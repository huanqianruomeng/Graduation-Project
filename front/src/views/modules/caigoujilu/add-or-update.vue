    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-select
              @change="shebeibianhaoChange"
              v-model="ruleForm.shebeibianhao"
              placeholder="请选择设备编号"
            >
              <el-option
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shebeimingcheng"
              placeholder="设备名称"
              clearable
              :readonly="ro.shebeimingcheng"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.caigoushuliang"
              placeholder="采购数量"
              clearable
              :readonly="ro.caigoushuliang"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.caigoujiage"
              placeholder="采购价格"
              clearable
              :readonly="ro.caigoujiage"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.caigougongsi"
              placeholder="采购公司"
              clearable
              :readonly="ro.caigougongsi"
            ></el-input>
          </el-form-item>
          <div v-else>
...
export default {
  ...
  methods: {
    ...
    shebeibianhaoChange() {
      this.$http({
        url:
          `follow/shiyanshebei/shebeibianhao?columnValue=` +
          this.ruleForm.shebeibianhao,
        method: "get",
      }).then(({ data }) => {
        if (data && data.code === 0) {
