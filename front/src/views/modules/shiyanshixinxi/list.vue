<template>
  <div class="main-content">
      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item :label="contents.inputTitle == 1 ? '实验室名称' : ''">
            <el-input
              ...
              v-model="searchForm.shiyanshimingcheng"
              placeholder="实验室名称"
              clearable
            ></el-input>
            <el-input
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '实验室规模' : ''">
            <el-input
              v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
              prefix-icon="el-icon-search"
              v-model="searchForm.shiyanshiguimo"
              placeholder="实验室规模"
              clearable
            ></el-input>
            <el-input
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '实验室状态' : ''">
            <el-input
              v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
              prefix-icon="el-icon-search"
              v-model="searchForm.shiyanshizhuangtai"
              placeholder="实验室状态"
              clearable
            ></el-input>
            <el-input
        ...
        >
          <el-form-item>
            ...
            <el-button
              v-if="
                isAuth('shiyanshixinxi', '新增') && contents.btnAdAllIcon == 0
              "
              type="success"
              @click="addOrUpdateHandler()"
              >{{ contents.btnAdAllFont == 1 ? "新增" : "" }}</el-button
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.shiyanshitupian">
                <img
                  :src="scope.row.shiyanshitupian.split(',')[0]"
                  width="100"
                  height="100"
                />
              </div>
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('shiyanshixinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                ...
                size="mini"
                @click="
                  shiyanshiyuyueCrossAddOrUpdateHandler(scope.row, 'cross')
                "
                >{{ contents.tableBtnFont == 1 ? "预约" : "" }}</el-button
              >
              <el-button
                v-if="
                  isAuth('shiyanshixinxi', '预约') &&
                ...
                @click="
                  shiyanshiyuyueCrossAddOrUpdateHandler(scope.row, 'cross')
                "
                >{{ contents.tableBtnFont == 1 ? "预约" : ""
                }}<i class="el-icon-tickets el-icon--right"
              /></el-button>
              <el-button
                v-if="
                  isAuth('shiyanshixinxi', '预约') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="
              ...
              <el-button
                v-if="
                  isAuth('shiyanshixinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('shiyanshixinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
    ...
    <shiyanshiyuyue-cross-add-or-update
      v-if="shiyanshiyuyueCrossAddOrUpdateFlag"
      :parent="this"
      ref="shiyanshiyuyueCrossaddOrUpdate"
    ></shiyanshiyuyue-cross-add-or-update>
  </div>
</template>
<script>
...
export default {
  data() {
    return {
      ...
      contents: {
        ...
        inputTitleSize: "14px",
        btnAdAllBorderColor: "rgba(31, 147, 255, 0.73)",
        pageJumper: true,
        ...
        tableHeaderFontColor: "rgba(12, 12, 13, 0.67)",
        inputTitle: "1",
        tableBtnBorderRadius: "16px",
        btnAdAllFont: "1",
        btnAdAllDelFontColor: "#333",
        tableBtnIcon: "1",
        btnAdAllHeight: "40px",
        btnAdAllWarnBgColor: "rgba(190, 163, 18, 1)",
        btnAdAllBorderWidth: "1px",
        tableStripeFontColor: "#606266",
        tableBtnBorderStyle: "solid",
        inputHeight: "40px",
        btnAdAllBorderRadius: "16px",
        btnAdAllDelBgColor: "rgba(255, 215, 0, 1)",
        pagePrevNext: true,
        btnAdAllAddBgColor: "rgba(241, 215, 70, 1)",
        searchBtnFont: "1",
        tableIndex: true,
        btnAdAllIcon: "1",
        tableSortable: true,
        ...
        tableBtnEditBgColor: "rgba(255, 140, 0, 1)",
        inputBorderWidth: "1px",
        inputFontPosition: "1",
        inputFontColor: "rgba(82, 135, 234, 1)",
        pageEachNum: 10,
        tableHeaderBgColor: "rgba(227, 226, 226, 0.14)",
        inputTitleColor: "#333",
        btnAdAllBoxPosition: "1",
        tableBtnDetailBgColor: "rgba(255, 140, 0, 1)",
        inputIcon: "1",
        searchBtnIconPosition: "1",
        btnAdAllFontSize: "14px",
        inputBorderStyle: "solid",
        inputBgColor: "rgba(224, 220, 220, 0.15)",
        pageStyle: true,
        pageTotal: true,
        btnAdAllAddFontColor: "#333",
        tableBtnFont: "1",
        tableContentFontColor: "rgba(78, 79, 82, 1)",
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        this.searchForm.shiyanshimingcheng != "" &&
        this.searchForm.shiyanshimingcheng != undefined
      ) {
        params["shiyanshimingcheng"] =
          "%" + this.searchForm.shiyanshimingcheng + "%";
      }
      if (
        this.searchForm.shiyanshiguimo != "" &&
        this.searchForm.shiyanshiguimo != undefined
      ) {
        params["shiyanshiguimo"] = "%" + this.searchForm.shiyanshiguimo + "%";
      }
      if (
        this.searchForm.shiyanshizhuangtai != "" &&
        this.searchForm.shiyanshizhuangtai != undefined
      ) {
        params["shiyanshizhuangtai"] =
          "%" + this.searchForm.shiyanshizhuangtai + "%";
      }
      this.$http({
