    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shiyanshibianhao"
              placeholder="实验室编号"
              clearable
              :readonly="ro.shiyanshibianhao"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shiyanshimingcheng"
              placeholder="实验室名称"
              clearable
              :readonly="ro.shiyanshimingcheng"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item
        ...
        <el-col :span="12">
          ...
          >
            <el-select
              v-model="ruleForm.shiyanshiguimo"
              placeholder="请选择实验室规模"
            >
              <el-option
        ...
        <el-col :span="24">
          <el-form-item
            class="upload"
            v-if="type != 'info' && !ro.shiyanshitupian"
            label="实验室图片"
          ...
          >
            <file-upload
              ...
              :multiple="true"
              :fileUrls="
                ruleForm.shiyanshitupian ? ruleForm.shiyanshitupian : ''
              "
          ...
          <div v-else>
            ...
            >
              <img
                ...
                v-bind:key="index"
                v-for="(item, index) in ruleForm.shiyanshitupian.split(',')"
                :src="item"
                width="100"
                height="100"
              />
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shiyanshiweizhi"
              placeholder="实验室位置"
              clearable
              :readonly="ro.shiyanshiweizhi"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item
        ...
        <el-col :span="12">
          ...
          >
            <el-select
              v-model="ruleForm.shiyanshizhuangtai"
              placeholder="请选择实验室状态"
            >
              <el-option
      ...
      <el-row>
        <el-col :span="24">
          ...
          <div v-else>
            <el-form-item
              v-if="ruleForm.shiyanshixiangqing"
              label="实验室详情"
              prop="shiyanshixiangqing"
            >
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.shiyanshixiangqing =
            this.ruleForm.shiyanshixiangqing.replace(
              reg,
              "../../../springboote51e2/upload",
            );
        } else {
          this.$message.error(data.msg);
        }
