    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shebeishuliang"
              placeholder="设备数量"
              clearable
              :readonly="ro.shebeishuliang"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-select
              v-model="ruleForm.shebeizhuangtai"
              placeholder="请选择设备状态"
            >
              <el-option
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        xinghao: [{ required: true, message: "型号不能为空", trigger: "blur" }],
        danwei: [],
        tupian: [],
        shebeishuliang: [
