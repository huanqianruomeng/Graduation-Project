      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item :label="contents.inputTitle == 1 ? '设备名称' : ''">
            <el-input
              ...
              v-model="searchForm.shebeimingcheng"
              placeholder="设备名称"
              clearable
            ></el-input>
            <el-input
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '设备状态' : ''">
            <el-input
              v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
              prefix-icon="el-icon-search"
              v-model="searchForm.shebeizhuangtai"
              placeholder="设备状态"
              clearable
            ></el-input>
            <el-input
        ...
        >
          <el-form-item>
            ...
            <el-button
              v-if="
                isAuth('shiyanshebei', '新增') && contents.btnAdAllIcon == 0
              "
              type="success"
              @click="addOrUpdateHandler()"
              >{{ contents.btnAdAllFont == 1 ? "新增" : "" }}</el-button
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('shiyanshebei', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('shiyanshebei', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('shiyanshebei', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        this.searchForm.shebeimingcheng != "" &&
        this.searchForm.shebeimingcheng != undefined
      ) {
      ...
      if (
        this.searchForm.shebeizhuangtai != "" &&
        this.searchForm.shebeizhuangtai != undefined
      ) {
