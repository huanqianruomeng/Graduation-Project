      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item>
            <el-button
              v-if="
                isAuth('discussshiyankecheng', '新增') &&
            ...
            <el-button
              v-if="
                isAuth('discussshiyankecheng', '删除') &&
                contents.btnAdAllIcon == 1 &&
                contents.btnAdAllIconPosition == 1 &&
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('discussshiyankecheng', '修改') &&
                  contents.tableBtnIcon == 1 &&
                  contents.tableBtnIconPosition == 1
                "
                type="primary"
              ...
              <el-button
                v-if="
                  isAuth('discussshiyankecheng', '查看评论') &&
                  contents.tableBtnIcon == 1 &&
                  contents.tableBtnIconPosition == 1
                "
                type="primary"
...
export default {
  ...
  methods: {
    ...
    disscussListHandler(id, type) {
      this.$router.push({
        path: "/discussdiscussshiyankecheng",
        query: { refid: id },
      });
    },
    // 下载
